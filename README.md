...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/Arculus-Holdings-L-L-C/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/Arculus-Holdings-L-L-C/solana-go@v1.8.4
```
...
You can wait for a transaction confirmation using the `github.com/Arculus-Holdings-L-L-C/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/Arculus-Holdings-L-L-C/solana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/Arculus-Holdings-L-L-C/solana-go"
  "github.com/Arculus-Holdings-L-L-C/solana-go/programs/system"
  "github.com/Arculus-Holdings-L-L-C/solana-go/rpc"
  "github.com/Arculus-Holdings-L-L-C/solana-go/text"
)
...
import (
  ...
  "github.com/Arculus-Holdings-L-L-C/solana-go/rpc"
  "github.com/Arculus-Holdings-L-L-C/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/Arculus-Holdings-L-L-C/solana-go/programs/system"
  "github.com/Arculus-Holdings-L-L-C/solana-go/rpc"
  confirm "github.com/Arculus-Holdings-L-L-C/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/Arculus-Holdings-L-L-C/solana-go/rpc/jsonrpc"
...
import (
  ...
  "github.com/davecgh/go-spew/spew"
  bin "github.com/gagliardetto/binary"
  solana "github.com/Arculus-Holdings-L-L-C/solana-go"
  "github.com/Arculus-Holdings-L-L-C/solana-go/programs/token"
  "github.com/Arculus-Holdings-L-L-C/solana-go/rpc"
)
